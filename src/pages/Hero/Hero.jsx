...
// REMOVED: import "@/assets/css/tomorrow.css"; - File doesn't exist
...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    name: 'Bharath Yadav Puni',
    title: 'Full‑Stack Developer | MERN Stack Developer | React & Node.js Developer',
    skills: [
        'ReactJS', 'NodeJS', 'Tailwind CSS', 'ExpressJS', 'MongoDB', 'HTML', 
        'JavaScript', 'Python','Git', 'DSA' , 'VS Code', 'Animations'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
                  ...
                  <span className="relative inline-block">
                    I&apos;m
                    <span className="typing-effect gradient-text"> Bharath Yadav Puni</span>
                  </span>
                </h1>
                <div className="absolute -z-10 top-1/2 -translate-y-1/2 left-1/4 w-24 sm:w-32 h-24 sm:h-32 bg-blue-500/20 rounded-full blur-2xl animate-pulse"></div>
              </div>

              <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl bg-linear-to-r from-blue-500/10 to-teal-500/10 border border-blue-500/20 mb-6 sm:mb-8 backdrop-blur-sm">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full‑Stack Developer 🎯 | Turning designs into pixel-perfect reality 🧩
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                ...
                <a
                  href="https://www.linkedin.com/in/bharath-yadav-puni/"
                  className="group relative inline-flex items-center justify-center gap-3 bg-linear-to-r from-blue-500 to-teal-400 p-0.5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]"
                >
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 transition-all duration-300 group-hover:bg-linear-to-r group-hover:from-blue-500 group-hover:to-teal-400">
                    <span className="relative flex items-center justify-center gap-2 text-white font-medium">
                ...
                <a
                  href="https://drive.google.com/file/d/1emWB8swalsr6ancP7_HcoV2UI4XghV8d/view?usp=drive_link"
              ...
              <div className="hidden lg:block absolute left-22 top-[2.3rem] animate-float-slow">
              ...
              <div className="hidden lg:block absolute top-68 left-[70%] transform -translate-x-1/2 animate-float">
