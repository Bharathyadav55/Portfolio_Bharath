    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          ...
          icon: <MdAnimation className="w-4 h-4 text-[#42A5F5]" />,
        },
        {
          name: "GSAP",
          icon: <MdAnimation className="w-4 h-4 text-[#AB47BC]" />,
        },
        {
          name: "Locomotive.js",
          icon: <MdAnimation className="w-4 h-4 text-[#FFB300]" />,
        },
        {
          name: "Textillate.js",
          icon: <MdAnimation className="w-4 h-4 text-[#26C6DA]" />,
        },
        {
          name: "Skiper UI",
          icon: <MdAnimation className="w-4 h-4 text-[#EC407A]" />,
        },
      ],
    },
  ];
